...
export function HomeHero() {
  return (
    <section className="relative isolate overflow-hidden rounded-[28px] px-4 py-9 sm:rounded-[36px] sm:px-10 sm:py-14 lg:px-14 lg:py-16">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-10 top-4 -z-10 h-40 w-40 rounded-full bg-[rgba(255,90,60,0.16)] blur-2xl sm:h-56 sm:w-56"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -left-8 bottom-0 -z-10 h-32 w-32 rounded-full bg-[rgba(255,159,67,0.2)] blur-2xl"
      />

      <div className="mx-auto max-w-3xl">
        <p className="text-center text-sm font-extrabold uppercase tracking-wide text-[var(--accent)] sm:text-base">
          Уже 4 800+ вручений
        </p>
        ...
        <p className="mx-auto mt-3 max-w-xl text-center text-base font-bold text-[var(--muted)] sm:text-lg">
          Выберите человека — подберём готовые идеи под повод и бюджет
        </p>

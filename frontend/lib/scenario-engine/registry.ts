    ...
    steps: [
      {
        ...
        options: [
          ...
          { value: "девушке", label: "Девушке" },
          { value: "парню", label: "Парню" },
          { value: "жене", label: "Жене" },
          { value: "мужу", label: "Мужу" },
          { value: "брату", label: "Брату" },
          { value: "сестре", label: "Сестре" },
          { value: "бабушке", label: "Бабушке" },
          { value: "дедушке", label: "Дедушке" },
          { value: "другу", label: "Другу" },
          { value: "подруге", label: "Подруге" },
          { value: "коллеге", label: "Коллеге" },
          { value: "начальнику", label: "Начальнику" },
          { value: "учителю", label: "Учителю" },
